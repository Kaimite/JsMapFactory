	...
	<body>
		...
		<div class="container">
			<header class="subhead" id="overview" style="padding-top: 45px; padding-bottom: 15px;">
				<h1>Evénements</h1>
				<p class="lead">Ajout d'événements sur une carte.<br><em>Cliquez sur la carte pour ajouter un marker</em></p>
			</header>
...
theMap.addEvent('click', function (e) {
	
	var latLng 		= theMap.getLanLngFromEvent(e),
		eventPoint 	= new Kaimite.Map.Point(latLng.lat, latLng.lng),
		eventMarker = new Kaimite.Map.Marker(eventPoint);
	
	theMap.addMarker( eventMarker, true );
});
</pre>								
