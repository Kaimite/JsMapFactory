	...
	<body>
		...
		<div class="container">
			<header class="subhead" id="overview" style="padding-top: 45px; padding-bottom: 15px;">
				<h1>Marker complexe</h1>
				<p class="lead">Exemple de carte avec un marker complexe GoogleMap / Bing</p>
			</header>
...
var provider 	= $("#provider").val(),
	...
	theIcon		= new Kaimite.Map.Marker.Icon("../img/beachflag.png"),
	theShadow	= new Kaimite.Map.Marker.Shadow("../img/beachflag_shadow.png");
...
theIcon.setSize(20,32);
theIcon.setOriginPoint(0,0);
theIcon.setAnchorPoint(0,32);
theMarker.setIcon(theIcon);

//--> Configuration de l'ombre
theShadow.setSize(37,32);
theShadow.setOriginPoint(0,0);
theShadow.setAnchorPoint(0,32);
theMarker.setShadow(theShadow);

//--> Zone de clic du marker
theMarker.setShape([1, 1, 1, 20, 18, 20, 18 , 1], "poly");

//--> Indique si on peut déplacer le marker
